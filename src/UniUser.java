 ...
 * @author Igor
 */
public class UniUser extends javax.swing.JFrame {
        ...
        if (jToggleButton1.isSelected()) {
            ...
            if (threadIn.isAlive()) {
                try {               
                    ...
                    Logger.getLogger(UniUser.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UniUser.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
